...
program_dir = configHelper.read_config(config_file, "gris", "program_dir", default_value="C:\\Users\\Owner\\Documents\\gris_paint")
...
def start_ord():
    ...
    pid = win32_functions.get_pid_window(process_name)
...
if __name__ == '__main__':
    if os.path.isfile(inputs_file):
        ord_reader.read_inputs(inputs_file, ord, wait=0)
